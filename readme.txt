...
[ConvertKit](https://convertkit.com?utm_source=wordpress&utm_content=convertkit) makes it easy to grow your email subscribers lists, sell more products and send targeted email newsletters - all by easily embedding email marketing / email subscriber forms anywhere on your WordPress web site.

= Email Marketing and Email Newsletter Features =

- Design [subscription forms](https://convertkit.com/features/forms?utm_source=wordpress&utm_content=convertkit) in ConvertKit, automatically appending them to any WordPress post or page, or displaying forms within your WordPress content using the supplied Gutenberg block and shortcode options. Perfect for building your email subscriber lists.
- Build [landing pages](https://convertkit.com/features/landing-pages?utm_source=wordpress&utm_content=convertkit) in ConvertKit, and display them on a WordPress page to capture email subscribers
- List past [email newsletters](https://convertkit.com/features/email-marketing?utm_source=wordpress&utm_content=convertkit) on your WordPress site

= Forms =

Design [forms](https://convertkit.com/features/forms?utm_source=wordpress&utm_content=convertkit) in ConvertKit, choosing from a variety of designs, customisable to your branding.
...
Embed [landing pages](https://convertkit.com/features/landing-pages?utm_source=wordpress&utm_content=convertkit), designed in ConvertKit, on your WordPress web site, choosing from a variety of designs, customisable to your branding and ideal for building your email marketing list or selling a product.
...
Use ConvertKit's [email marketing](https://convertkit.com/features/email-marketing?utm_source=wordpress&utm_content=convertkit) feature to send email newsletters to your subscribers and leads.
...
If you are not yet using ConvertKit, [creating an account](https://app.convertkit.com/users/signup?plan=1k&utm_source=wordpress&utm_content=convertkit) is 100% free and only takes you about 30 seconds.

= Documentation =

Full Plugin documentation can be found [here](https://help.convertkit.com/en/articles/2502591-the-convertkit-wordpress-plugin?utm_source=wordpress&utm_content=convertkit).
...
No. You must first have an account on [convertkit.com](https://convertkit.com?utm_source=wordpress&utm_content=convertkit), but you do not have to use a paid plan!
