...
class EditFormLinkCest
{
	...
	public function testEditFormLinkOnPage(AcceptanceTester $I)
	{
		...
		$I->seeInSource('<a href="https://app.kit.com/forms/designers/' . $_ENV['CONVERTKIT_API_FORM_ID'] . '/edit/?utm_source=wordpress&amp;utm_term=en_US&amp;utm_content=convertkit" target="_blank">Edit form in ConvertKit</a>');
	}
	...
	public function testEditFormLinkOnPageWithLegacyForm(AcceptanceTester $I)
	{
		...
		// Confirm that the Edit Form link is displayed.
		$I->seeInSource('<a href="https://app.kit.com/landing_pages/' . $_ENV['CONVERTKIT_API_LEGACY_FORM_ID'] . '/edit/?utm_source=wordpress&amp;utm_term=en_US&amp;utm_content=convertkit" target="_blank">Edit form in ConvertKit</a>');
	}
