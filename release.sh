...
then
  echo "Error: GITHUB_ACCESS_TOKEN environment variable is not defined. You can generate one at https://github.com/settings/tokens"
  exit 1
fi
...
GITHUB_REPO_OWNER="ConvertKit"

# GITHUB Repository name
GITHUB_REPO_NAME="ConvertKit-WordPress"
