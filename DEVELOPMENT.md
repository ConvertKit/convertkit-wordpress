...
This document describes the high level workflow used when working on the Kit (formerly ConvertKit) WordPress Plugin.
...
- Kit (formerly ConvertKit) WordPress Libraries; a shared connection of WordPress specific API, Resource and Review Request classes that are used
across multiple Kit (formerly ConvertKit) WordPress Plugins.
